...
class PoseController extends GetxController {
  ...
  var poseCalculationDict = {
    ...
    BasePose.rightLegUp: 0.0,
    BasePose.gap: 0.0,
    BasePose.leftArmUpRightArmMiddle: 0.0,
  ...
  var posePerformance = {GamePlayModes.leftArmUp: false, GamePlayModes.leftArmMiddle: false, GamePlayModes.leftArmUpAndMiddle: false, GamePlayModes.rightArmUp: false, GamePlayModes.rightArmMiddle: false, GamePlayModes.rightArmUpAndMiddle: false, GamePlayModes.leftAndRightArmUp: false, GamePlayModes.leftAndRightArmMiddle: false, GamePlayModes.leftAndRightArmUpAndMiddleSamePosition: false, GamePlayModes.leftAndRightArmUpAndMiddleDiffPosition: false, GamePlayModes.leftAndRightArmAll: false, GamePlayModes.leftLegUp: false, GamePlayModes.rightLegUp: false, GamePlayModes.leftAndRightLegUp: false, GamePlayModes.legGap: false, GamePlayModes.squat: false, GamePlayModes.all: false};
}
